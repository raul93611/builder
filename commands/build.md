...
- For each feature:
  - Build the backend logic first (API routes, database queries)
  - Then build the UI
  - Commit after each feature is complete with a clear message: `feat: add [feature name]`
...
2. Do NOT push to main. Leave the branch ready for review.
...
3. Report to the user:
   ...
   - Next steps (review branch, run locally, push when ready)
